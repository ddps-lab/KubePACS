...
class AwsVirtualMachine(virtual_machine.BaseVirtualMachine):
  ...
  def __init__(self, vm_spec):
    ...
    self.use_dedicated_instance = FLAGS.aws_use_dedicated_instance
    ...
    if self.use_dedicated_instance and self.use_spot_instance:
      raise ValueError('Tenancy=dedicated is not supported for Spot Instances')
    
    if self.use_dedicated_host and self.use_dedicated_instance:
      raise ValueError('Cannot use both dedicated host and dedicated instance simultaneously')
  ...
  def _GenerateCreateCommand(self):
    ...
    elif self.use_dedicated_instance:
      placement.append('Tenancy=dedicated')
  ...
  def GetResourceMetadata(self):
    ...
    if self.use_dedicated_instance:
      result['dedicated_instance'] = True
