...
summaryfile = "golden_section_summary.csv"
...
result_dir = "./data"
result_folders = sorted([f for f in os.listdir(result_dir) if os.path.isdir(os.path.join(result_dir, f))])
golden_summaryfile = "golden_section_summary.csv"
...
# ===== 저장 및 출력 =====
plt.savefig('distribution-of-alphas-to-workloads-short.pdf', format="pdf", dpi=300, bbox_inches='tight')
plt.show()
...
# ===== 저장 및 출력 =====
plt.savefig('distribution-of-alphas-to-workloads.pdf', format="pdf", dpi=300, bbox_inches='tight')
plt.show()
